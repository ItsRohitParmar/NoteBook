...
router.post('/createuser', [
    ...
    try {
        ...
        //Checking all registered emails.
        ...
        // This is to make password encrypted with GenSalt
        ...
        //Payload data for authentication token: "Adding User Specific ID in payload data"
        var data = {
            user: {
                id: user.id
            }
        }
        //encrypting and Signing the payload data with jwt_secret : "creating auth_token with data and secreat sign"
...
router.post('/login', [
    ...
    try {
        ...
        let user = await user_collection.findOne({ email: `${email}` });
